...
export default function Insta() {
  return (
    <div className="bg-white flex flex-col h-[300px] justify-center items-center px-4 md:px-8 lg:h-[400px]">
      ...
      <button className="w-[200px] sm:w-[250px] h-[50px] sm:h-[60px] text-center rounded-[50px] my-5 shadow-custom bg-gradient-to-r from-blue-500 to-purple-500 text-white hover:scale-105 transition-all duration-300">
        Follow Us
      </button>
    </div>
  )
